(function ($, Backdrop, CKEditor5) {
  ...
  class AI extends CKEditor5.core.Plugin {
    ...
    updateStatus(statusText, editorContainer) {
      let statusElement = editorContainer.querySelector('.ck-ai-status');
      if (!statusElement) {
        statusElement = document.createElement('div');
        statusElement.classList.add('ck-ai-status');
        editorContainer.appendChild(statusElement);
        statusElement.style.textAlign = 'right';
        statusElement.style.marginTop = '5px';
        statusElement.style.color = '#333';
      }
      statusElement.textContent = `AI status: ${statusText}`;
    }
    ...
    init() {
      ...
      editor.ui.componentFactory.add('AI', locale => {
        ...
        const items = [
          { label: 'Text Completion', commandName: 'aiCompleteText' },
          { label: 'Adjust tone/voice', commandName: 'aiAdjustTone' },
          { label: 'Summarize', commandName: 'aiSummarize' },
          { label: 'Translate', commandName: 'aiTranslate' },
          { label: 'Reformat/correct HTML', commandName: 'aiReformat'},
          { label: 'Help & Support', href: 'https://github.com/backdrop-contrib/ai/issues', isLink: true },
        ];
    ...
    _createForm({ labelText, inputId, submitCallback, cancelCallback }) {
      ...
      const existingForm = document.getElementById('ck-ai-form');
      if (existingForm) {
      ...
      formElement.id = 'ck-ai-form'; // Assign a unique ID
      formElement.classList.add('ck-ai-form');
  ...
  `;
      ...
      formElement.classList.add('ck-ai-form-modal');
      ...
      this._createForm({
        ...
        submitCallback: (formElement) => {
          ...
          if (inputValue) {
            ...
            this._sendPromptToAI(inputValue, editorContainer);
          }
          this._closeForm(formElement);
        },
        cancelCallback: (formElement) => {
